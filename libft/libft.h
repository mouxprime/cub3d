...
/*   Updated: 2025/01/24 14:20:35 by jmenard          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef struct trash_collector
{
	void					*alloc;
	int						lock;
	struct trash_collector	*next;
}							t_trash;

typedef struct trash_file
{
	int						fd;
	struct trash_file		*next;
}							t_trash_files;
...
t_list						*ft_lstmap(t_list *lst, void *(*f)(void *),
								void (*del)(void *));
void						*ft_malloc(size_t nmemb, size_t size, int lock,
								int exit_status);
